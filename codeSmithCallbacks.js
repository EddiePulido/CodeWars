...
function rating(arrOfFuncs, value) {
	return arrOfFuncs.reduce((a,c) => a + +(c(value)), 0) / arrOfFuncs.length * 100
}
...
function pipe(arrOfFuncs, value) {
	return arrOfFuncs.reduce((a,c) => c(a), value)
}
...
function highestFunc(objOfFuncs, subject) {
  ...
  for(const funcName in objOfFuncs){
    const r = objOfFuncs[funcName](subject)
...
function combineOperations(startVal, arrOfFuncs) {
	return arrOfFuncs.reduce((a,c) => c(a), startVal)
}
